 ...
 * ───────────────────────────────────────────── 
 */
#define WSH_SHELL_DEV_NAME_LEN			32	 // Device name max length
 ...
 * ───────────────────────────────────────────── 
 */
#define WSH_SHELL_ASSERT(exp) ASSERT_CHECK(exp)
...
#define RET_STATE_MAP_TABLE()                                             \
	X_MAP_ENTRY(RET_STATE_SUCCESS, WSH_SHELL_RET_STATE_SUCCESS)           \
	X_MAP_ENTRY(RET_STATE_WARNING, WSH_SHELL_RET_STATE_WARNING)           \
	X_MAP_ENTRY(RET_STATE_ERROR, WSH_SHELL_RET_STATE_ERROR)               \
	X_MAP_ENTRY(RET_STATE_ERR_EMPTY, WSH_SHELL_RET_STATE_ERR_EMPTY)       \
	X_MAP_ENTRY(RET_STATE_ERR_PARAM, WSH_SHELL_RET_STATE_ERR_PARAM)       \
	X_MAP_ENTRY(RET_STATE_ERR_BUSY, WSH_SHELL_RET_STATE_ERR_BUSY)         \
	X_MAP_ENTRY(RET_STATE_ERR_OVERFLOW, WSH_SHELL_RET_STATE_ERR_OVERFLOW) \
	X_MAP_ENTRY(RET_STATE_ERR_MEMORY, WSH_SHELL_RET_STATE_ERR_MEMORY)     \
	X_MAP_ENTRY(RET_STATE_ERR_TIMEOUT, WSH_SHELL_RET_STATE_ERR_TIMEOUT)   \
	X_MAP_ENTRY(RET_STATE_ERR_CRC, WSH_SHELL_RET_STATE_ERR_CRC)           \
	X_MAP_ENTRY(RET_STATE_UNDEF, WSH_SHELL_RET_STATE_UNDEF)

static inline RET_STATE_t WshShellRetState_TranslateToProject(WSH_SHELL_RET_STATE_t state) {
	switch (state) {
